...
var items = [{
    ...
    {
        label: '$WM_ACTIVATE',
        documentation: '= 0x0006. Sent to both the window being activated and the window being deactivated. If the windows use the same input queue, the message is sent synchronously, first to the window procedure of the top-level window being deactivated, then to the window procedure of the top-level window being activated. If the windows use different input queues, the message is sent asynchronously, so the window is activated immediately.',
        detail: 'Windows Mesage Code'
    },
    {
        label: '$WM_ACTIVATEAPP',
        documentation: '= 0x001C. Sent when a window belonging to a different application than the active window is about to be activated. The message is sent to the application whose window is being activated and to the application whose window is being deactivated.',
        detail: 'Windows Mesage Code'
    },
    {
        label: '$WM_AFXFIRST',
    ...
    {
        label: '$WM_APP',
        documentation: '= 0x8000. Used to define private messages, usually of the form WM_APP+x, where x is an integer value.',
        detail: 'Windows Mesage Code'
    },
    {
        label: '$WM_APPCOMMAND',
        documentation: '= 0x0319. Notifies a window that the user generated an application command event, for example, by clicking an application command button using the mouse or typing an application command key on the keyboard.',
        detail: 'Windows Mesage Code'
    },
    {
        label: '$WM_ASKCBFORMATNAME',
        documentation: '= 0x030C. Sent to the clipboard owner by a clipboard viewer window to request the name of a CF_OWNERDISPLAY clipboard format.\n\nA window receives this message through its WindowProc function.',
        detail: 'Windows Mesage Code'
    },
    {
        label: '$WM_CANCELJOURNAL',
        documentation: '= 0x004B. Posted to an application when a user cancels the application\'s journaling activities. The message is posted with a NULL window handle.',
        detail: 'Windows Mesage Code'
    },
    {
        label: '$WM_CANCELMODE',
