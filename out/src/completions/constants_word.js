...
let WdPrintOutItem = [
    { label: '$WdPrintAutoTextEntries', documentation: `${descriptionHeader}|Autotext entries in the current document.|4 ` },
    { label: '$WdPrintComments', documentation: `${descriptionHeader}|Comments in the current document.|2 ` },
    { label: '$WdPrintDocumentContent', documentation: `${descriptionHeader}|Current document content.|0 ` },
    { label: '$WdPrintDocumentWithMarkup', documentation: `${descriptionHeader}|Current document content including markup.|7 ` },
    { label: '$WdPrintEnvelope', documentation: `${descriptionHeader}|An envelope.|6 ` },
    { label: '$WdPrintKeyAssignments', documentation: `${descriptionHeader}|Key assignments in the current document.|5 ` },
    { label: '$WdPrintMarkup', documentation: `${descriptionHeader}|Markup in the current document.|2 ` },
    { label: '$WdPrintProperties', documentation: `${descriptionHeader}|Properties in the current document.|1 ` },
    { label: '$WdPrintStyles', documentation: `${descriptionHeader}|Styles in the current document.|3 ` },
]
...
let WdPrintOutPages = [
    ...
    { label: '$WdPrintEvenPagesOnly', documentation: `${descriptionHeader}|Even-numbered pages only.|2` },
    { label: '$WdPrintOddPagesOnly', documentation: `${descriptionHeader}|Odd-numbered pages only.|1` },
]
...
let WdPrintOutRange = [
    ...
    { label: '$WdPrintRangeOfPages', documentation: `${descriptionHeader}|A specified range of pages.|4` },
...
let WdSaveFormat = [
    { label: '$WdFormatDocument', documentation: `${descriptionHeader}|Microsoft Office Word format.|0` },
    { label: '$WdFormatDOSText', documentation: `${descriptionHeader}|Microsoft DOS text format.|4` },
    { label: '$WdFormatDOSTextLineBreaks', documentation: `${descriptionHeader}|Microsoft DOS text with line breaks preserved.|5` },
    { label: '$WdFormatEncodedText', documentation: `${descriptionHeader}|Encoded text format.|7` },
    { label: '$WdFormatFilteredHTML', documentation: `${descriptionHeader}|Filtered HTML format.|10` },
    ...
    { label: '$WdFormatText', documentation: `${descriptionHeader}|Microsoft Windows text format.|2` },
    { label: '$WdFormatTextLineBreaks', documentation: `${descriptionHeader}|Windows text format with line breaks preserved.|3` },
    ...
    { label: '$WdFormatXML', documentation: `${descriptionHeader}|Extensible Markup Language (XML) format.|11` },
    { label: '$WdFormatDocument97', documentation: `${descriptionHeader}|Microsoft Word 97 document format.|0` },
    { label: '$WdFormatDocumentDefault', documentation: `${descriptionHeader}|Word default document file format. For Microsoft Office Word 2007, this is the DOCX format.|16` },
    { label: '$WdFormatPDF', documentation: `${descriptionHeader}|PDF format.|17` },
    { label: '$WdFormatTemplate97', documentation: `${descriptionHeader}|Word 97 template format.|1` },
    { label: '$WdFormatXMLDocument', documentation: `${descriptionHeader}|XML document format.|12` },
    { label: '$WdFormatXMLDocumentMacroEnabled', documentation: `${descriptionHeader}|XML document format with macros enabled.|13` },
    { label: '$WdFormatXMLTemplate', documentation: `${descriptionHeader}|XML template format.|14` },
    { label: '$WdFormatXMLTemplateMacroEnabled', documentation: `${descriptionHeader}|XML template format with macros enabled.|15` },
...
let WdSaveOptions = [
    { label: '$WdDoNotSaveChanges', documentation: `${descriptionHeader}|Do not save pending changes.|0` },
    { label: '$WdPromptToSaveChanges', documentation: `${descriptionHeader}|Prompt the user to save pending changes.|-2` },
    { label: '$WdSaveChanges', documentation: `${descriptionHeader}|Save pending changes automatically without prompting the user.|-1` },
]
...
let WdUnits = [
    ...
    { label: '$WdCharacterFormatting', documentation: `${descriptionHeader}|Character formatting.|13` },
    ...
    { label: '$WdParagraphFormatting', documentation: `${descriptionHeader}|Paragraph formatting.|14` },
