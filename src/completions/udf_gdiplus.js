...
const items = [
  ...
  },
  {
    ...
    documentation:
      'Initialize Microsoft Windows GDI+_GDIPlus_ArrowCapCreate Creates an adjustable arrow line cap with the specified height and width',
  },
  {
  ...
  },
  {
    ...
    documentation:
      'Sets the distance between the base cap to the start of the line_GDIPlus_BitmapApplyEffect Alters a Bitmap by applying a specified effect',
  },
  {
  ...
  },
  {
    ...
    documentation:
      'Initializes a standard, optimal, or custom color palette_GDIPlus_BrushClone Clone a Brush object',
  },
  {
  ...
  },
  {
    ...
    documentation:
      'Retrieve the type of Brush object_GDIPlus_HatchBrushCreate Creates a HatchBrush object based on a hatch style, a foreground color, and a background color_GDIPlus_LineBrushCreate Creates a LinearGradientBrush object from a set of boundary points and boundary colors',
  },
  {
  ...
  },
  {
    ...
    documentation:
      'Set the color of a Solid Brush object_GDIPlus_TextureCreate Creates a TextureBrush object based on an image and a wrap mode',
  },
  {
  ...
  },
  {
    ...
    documentation:
      'Creates a TextureBrush object based on an image, a defining rectangle, and a set of image properties_GDIPlus_EffectCreate Creates an Effect object of the type specified by the guid parameter',
  },
  {
  ...
  },
  {
    ...
    documentation:
      'Sets the parameters for the specified Effect object_GDIPlus_FontCreate Create a Font object',
  },
  {
  ...
  },
  {
    ...
    documentation:
      'Gets the line spacing of a font in the current unit of a specified Graphics object_GDIPlus_FontPrivateAddFont Adds a font file to the private font collection',
  },
  {
  ...
  },
  {
    ...
    documentation:
      'Creates a PrivateFont Collection object_GDIPlus_FontFamilyCreate Create a Font Family object',
  },
  {
  ...
  },
  {
    ...
    documentation:
      'Gets the line spacing, in design units, of this font family for the specified style or style combination_GDIPlus_GraphicsClear Clears a Graphics object to a specified color',
  },
  {
  ...
  },
  {
    ...
    documentation:
      "Updates a Graphics object's world transformation matrix with the product of itself and a translation matrix_GDIPlus_Decoders Get an array of information about the available image decoders",
  },
  {
  ...
  },
  {
    ...
    documentation:
      'Get an encoder parameter size_GDIPlus_PathAddArc Adds an elliptical arc to the current figure of a path',
  },
  {
  ...
  },
  {
    ...
    documentation:
      "Transforms and flattens a path, and then converts the path's data points so that they represent only the outline of the path_GDIPlus_DrawImageFX Draws a portion of an image after applying a specified effect",
  },
  {
  ...
  },
  {
    ...
    documentation:
      'Sets or clears the color- and grayscale-adjustment matrices for a specified category_GDIPlus_MatrixClone Clones a Matrix object',
  },
  {
  ...
  },
  {
    ...
    documentation:
      'Updates a matrix with the product of itself and a translation matrix_GDIPlus_ColorMatrixCreate Creates and initializes an identity color matrix',
  },
  {
  ...
  },
  {
    ...
    documentation:
      'Sets a series of character ranges for a StringFormat object that, when in a string, can be measured_GDIPlus_GraphicsDrawString Draw a string',
  },
  {
