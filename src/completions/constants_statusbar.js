...
var items = [{
    ...
    {
        label: '$SBT_POPOUT',
        documentation: ' The text is drawn with a border to appear higher than the plane of the window.\n\n`= 0x200`',
        detail: uFlag
    },
    {
        label: '$SBT_RTLREADING',
        documentation: '`SB_SETTEXT`, `SB_SETTEXT`, `SB_GETTEXTLENGTH` flags only: Displays text using right-to-left reading order on Hebrew or Arabic systems.\n\n`= 0x400`',
        detail: uFlag
    },
    {
    ...
    },
    {
        ...
        documentation: 'Sent when the simple mode changes due to a `$SB_SIMPLE` message\n\n`= $SBN_FIRST - 0`',
        detail: notify
    }
]
