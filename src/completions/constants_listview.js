...
var items = [{
    ...
    },
    {
        ...
        documentation: 'Column headers are not displayed in report view. By default, columns have headers in report view.',
        detail: 'ListView Style Constant'
    },
    {
        label: '$LVS_NOSORTHEADER',
        documentation: 'Column headers do not work like buttons. This style can be used if clicking a column header in report view does not carry out an action, such as sorting.',
        detail: 'ListView Style Constant'
    },
    {
        label: '$LVS_SINGLESEL',
    ...
    },
    {
        ...
        documentation: 'The selection, if any, is always shown, even if the control does not have the focus.',
        detail: 'ListView Style Constant'
    },
    {
    ...
    },
    {
        ...
        documentation: 'Item text is displayed on a single line in icon view. By default, item text may wrap in icon view.',
        detail: 'ListView Style Constant'
    },
    {
    ...
    },
    {
        ...
        documentation: 'Enables hot-track selection in a list view control. Hot track selection means that an item is automatically selected when the cursor remains over the item for a certain period of time',
        detail: 'ListView Extended Style Constant'
    },
    {
    ...
    },
    {
        ...
        documentation: 'If this style is set, when an item is selected the border color of the item changes rather than the item being highlighted.',
        detail: 'ListView Extended Style Constant'
    },
    {
        label: '$LVS_EX_DOUBLEBUFFER',
        documentation: 'Paints via double-buffering, which reduces flicker. This extended style also enables alpha-blended marquee selection on systems where it is supported.',
        detail: 'ListView Extended Style Constant'
    },
    {
        label: '$LVS_EX_FLATSB',
    ...
    },
    {
        ...
        documentation: 'The control will not autoarrange its icons until one or more work areas are defined.',
        detail: 'ListView Extended Style Constant'
    },
    {
    ...
    },
    {
        ...
        documentation: 'Displays a tooltip when the item is not fully visible. Sends a notification message to $LVN_GETINFOTIP',
        detail: 'ListView Extended Style Constant'
    },
]
...
for (var i of items) {
    ...
    i.documentation += '\n\nRequires #include <ListViewConstants.au3>'
}
